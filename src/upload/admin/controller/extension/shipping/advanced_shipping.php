...
class ControllerExtensionShippingAdvancedShipping extends Controller
{
    ...
    public function index()
    {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
            ...
            $this->response->redirect($this->url->link('extension/shipping/advanced_shipping', 'token=' . $this->session->data['token'] . '&store_id=' . $data['selected_store_id'], 'SSL'));
        }
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href' => $this->url->link('extension/shipping/advanced_shipping', 'token=' . $this->session->data['token'], 'SSL'),
            'separator' => ' :: '
        );
        
        $data['action'] = $this->url->link('extension/shipping/advanced_shipping', 'token=' . $this->session->data['token'], 'SSL');
